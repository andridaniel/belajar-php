...
class Dashboard {
    ...
    public function getCurrentIndonesianDateTime() {
...
$queryProduct = $database->query('SELECT COUNT(*) as count FROM products');
$productCount = $queryProduct->fetch_assoc()['count'];

// Mengambil jumlah pelanggan
$queryCustomer = $database->query('SELECT COUNT(*) as count FROM customers');
$customerCount = $queryCustomer->fetch_assoc()['count'];

// Mengambil jumlah vendor
$queryVendor = $database->query('SELECT COUNT(*) as count FROM vendors');
$vendorCount = $queryVendor->fetch_assoc()['count'];

// Ambil waktu dalam format Indonesia
$indonesianDateTime = $dashboard->getCurrentIndonesianDateTime();
?>
