...
class createProduct {
    ...
    public function insertProduct($namaProduct, $kategoriProduct, $kodeProduct, $deskripsi, $harga, $stock, $gambar) {
        // Upload gambar
        ...
        $sql = "INSERT INTO products (product_name, category_id, product_code, description, price, stock, image) VALUES (?, ?, ?, ?, ?, ?, ?)";
        $stmt = $this->db->prepare($sql);

        if ($stmt) {
            $stmt->bind_param("sssssss", $namaProduct, $kategoriProduct, $kodeProduct, $deskripsi, $harga, $stock, $gambar);
...
$productManager = new createProduct($database);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $productManager->insertProduct($namaProduct, $kategoriProduct, $kodeProduct, $deskripsi, $harga, $stock, $gambar);
}
