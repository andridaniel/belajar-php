...
class updateProduct {
    ...
    public function updateProduct($id, $namaproduct, $kategoriproduct, $kodeproduct, $deskripsi, $harga, $stock, $gambar, $gambarLama) {
...
$productManager = new updateProduct($database);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $productManager->updateProduct($id, $namaproduct, $kategoriproduct, $kodeproduct, $deskripsi, $harga, $stock, $_FILES['gambar'], $gambarLama);
}

$data = null;
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    $id = $_GET["id"];
    $data = $productManager->fetchProductById($id);
      ...
      <form action="update_product.php" method="post" enctype="multipart/form-data">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="namaproduct" class="form-control" id="namaproduct" required
          ...
          <div class="form-group">
            ...
            <input type="text" name="kodeproduct" class="form-control" id="kodeproduct" required
